    ...
    <div className="space-y-6">
      ...
      {filteredProjects.length > 0 ? (
            ...
            >
              ...
              <div className="flex items-center gap-4 shrink-0 ml-4">
                <div className="text-right hidden sm:block">
                  <p className="text-xs text-zinc-400">{project.network}</p>
                  <p className="text-[10px] text-zinc-400">{(project.enabledServices || []).length} services</p>
                </div>
        ...
        <div className="rounded-xl border border-dashed border-zinc-300 bg-white p-10 text-center dark:border-zinc-700 dark:bg-[#080809]">
          ...
          <p className="mt-1 text-xs text-zinc-500">Create a project to start using ZEXVRO's Web3 services.</p>
...
function CreateProjectWizard({ onClose, onCreate, existingProjectNames }: {
  ...
  const handleCreate = () => {
    onCreate({ name: name.trim(), description, purpose, network, enabledServices });
  };
        ...
        <div className="px-5 py-5">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="my-payroll-project"
                  autoFocus
                ...
                />
                {nameExists && (
                  <p className="mt-1 text-xs text-rose-500 font-medium">A project with this name already exists.</p>
                )}
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Run private payroll settlements on Stellar"
              ...
              <div>
                <label className="block text-xs font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Target Network</label>
                <select
                  value={network}
          ...
          {step === 1 && (
            <div className="space-y-2 max-h-[280px] overflow-y-auto pr-1">
              {[
                { id: 'srv-privacy', label: 'Zero-Knowledge Privacy Pool (Zer0)', desc: 'Private transactions and zero-knowledge payroll with Stellar settlement.' },
                { id: 'srv-transformation', label: 'Transformation Agent (Morph)', desc: 'Codebase analysis and automated Web2 → Web3 migrations.' },
