...
export function seedDemoTenant(stores: GateStores): {
  ...
  const site: SiteRecord = {
    ...
    allowedOrigins: ['http://localhost:5173', 'http://localhost:3000', 'http://localhost:4103', 'http://127.0.0.1:4103', 'http://127.0.0.1:3000', 'https://console.zexvro.in', 'https://zexvro.pages.dev'],
    name: 'Demo site',
